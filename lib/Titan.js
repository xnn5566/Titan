 ...
 * @api public
 */
Titan.startAppWithName = function (appName, callback){
    executeZeusMothed('startAppWithName',appName , callback);
}
 ...
 * @api public
 */
Titan.startAppAll = function (callback){
    executeZeusMothed('startAppAll', callback);
}
  ...
  * @api public
  */
Titan.stopAppWithName = function (appName, callback){
    executeZeusMothed('stopAppWithName', appName, callback);
}
 ...
 * @api public
 */
Titan.stopAppAll = function (callback){
    executeZeusMothed('stopAppAll', callback);
}
